# Generated by Powerlevel10k configuration wizard on 2025-12-17 at 13:17 +0545.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    mise                    # mise version manager (node/go/python)
    virtualenv              # python venv if active
    context                 # user@hostname (shows when SSH)
    time                    # current time
    # =========================[ Line #2 ]=========================
    newline                 # \n
  )
